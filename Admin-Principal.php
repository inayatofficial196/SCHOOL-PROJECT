...
<body>
    ...
    <nav>
        <ul>
            <li class="click"><a href="#"><i class="fa-solid fa-house"></i> Home</a>
                <ul>
                    <li><a href="#">Principal Image</a></li>
    ...
    <div class="myForm">
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="Name" id="principal" placeholder="Principal Name" required>
        </form>
    </div>
    ...
    if (isset($_POST['Submit'])) {
        ...
        if (in_array($imageFileType, $allowedExtensions)) {
            ...
            $sql = "INSERT INTO principal (image_name, image_path, principal_name, upload_date) VALUES ('$imageName', '$imagePath', '$principalName', NOW())";
    ...
    <div class="myTable">
        <table rules="rows" frame="border">
            ...
            <?php
            $sql = "SELECT * FROM principal ORDER BY upload_date DESC";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='Principal-Delete.php?id=$row[id]'>
                    <input type='submit' value='Delete' id='delete' onclick='return checkdelete()'></a></td>";
                    echo '</tr>';
                }
            } else {
                echo '<tr><td colspan="3">No Principal Images Available.</td></tr>';
            }
            $conn->close();
            ?>
        </table>
